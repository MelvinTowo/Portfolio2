  ...
  return (
    <section id="home" className="min-h-screen bg-gradient-to-br from-black-900 via-blue-900 to-black-900 relative overflow-hidden">
      ...
      <div className="absolute top-4 left-4 md:top-6 md:left-6 lg:top-8 lg:right-8 lg:left-auto flex space-x-2 md:space-x-3 lg:space-x-4">
        <a href="https://github.com/MelvinTowo" className="w-8 h-8 md:w-9 md:h-9 lg:w-10 lg:h-10 bg-white/10 backdrop-blur-lg rounded-full flex items-center justify-center text-white hover:bg-white/20 transition-all duration-300 hover:scale-110">
        ...
        <a href="https://www.linkedin.com/in/melvintowo/" className="w-8 h-8 md:w-9 md:h-9 lg:w-10 lg:h-10 bg-white/10 backdrop-blur-lg rounded-full flex items-center justify-center text-white hover:bg-white/20 transition-all duration-300 hover:scale-110">
          <svg className="w-4 h-4 md:w-4.5 md:h-4.5 lg:w-5 lg:h-5" fill="currentColor" viewBox="0 0 24 24">
